...
namespace MorganStanley.ComposeUI.Prototypes.ModulesDockingPrototype
{
    public class App : Application
    {
        ...
        // the IoC container
        private static IoCContainer _iocContainer = _pluginManager.TheContainer;
        ...
        public App()
        {
            ...
            _server = _iocContainer.Resolve<ICommunicationService>();
        ...
        public override void OnFrameworkInitializationCompleted()
        {
            ...
            {
                var loaderFactory = _iocContainer.Resolve<IModuleLoaderFactory>();
                var moduleHostFactory = _iocContainer.Resolve<IModuleHostFactory>();

                ProcessesViewModel viewModel = new ProcessesViewModel(loaderFactory, moduleHostFactory);
